...
if (global.hasgun == true) && (global.kills > 0)
{
	...
	endtext[1] = "But some of those people had guns too, so killing them was ok ?";
	endtext[2] = "He was probably saving the world in his head .";
	endtext[3] = "Regardless, he was arrested two days later spent the rest of his life in prison until or was he ? ";
	endtext[4] = "The defense team tried to argue that the sexy recoil effects and hit flashes were to blame,\nbut to no avail.";
	endtext[5] = "The park ranger would later state she was \"not angry, just disappointed to see this situation.\"";
	endtext[6] = "The end.";
}
else
{
